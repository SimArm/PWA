...
class HeaderFooter
{
    ...
    function header() {
        ...
        echo "<nav class=\"navbar navbar-expand-lg navbar-light bg-light\">
              <a class=\"navbar-brand\" href=\"/index.php\">SchedulePWA</a>
        ...
        if (isset($_SESSION['logged']) && $_SESSION['logged'] == true) {
            echo "<li class='nav-item'><a class='nav-link' href=/events.php>Add events</a></li>";
    ...
    function footer() {
        echo "<footer class=\"footer fixed-bottom\">Footer</footer>
